...
<<<<<<< HEAD
            ...
            <span className="icon">
              <a href="tel:+918525929495" target='_blank'><TbPhoneCall /></a>
            </span>
            <span className="icon">
              <a href="https://wa.me/+918525929495" target='_blank'><SiWhatsapp /></a>
            </span>
            <span className="icon">
              <a href="https://github.com/TamilD07" target='_blank'><AiFillGithub /></a>
            </span>
            <span className="icon">
              <a href="https://www.linkedin.com/in/tktamil-kumaranmtk/" target='_blank'><FaLinkedin /></a>
            </span>
            <span className="icon">
              <a href="https://x.com/Tamil_D07" target='_blank'><BsTwitterX /></a>
            </span>
            <span className="icon">
